...
# Fork Permissions
PRODUCT_COPY_FILES += \
    vendor/lineage/config/permissions/privapp-permissions-fork.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-fork.xml \
...
# FOD
ifneq ($(filter fajita davinci RMX1931 y2s,$(TARGET_DEVICE)),)
PRODUCT_PACKAGES += \
